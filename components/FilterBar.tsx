      ...
      <div className="flex flex-col gap-4 text-sm text-gray-600">
        ...
        <div className="flex flex-wrap items-center gap-4">
            ...
            <input 
                type="text" 
                placeholder="请输入内容" 
                className="border border-gray-300 rounded px-3 py-1.5 w-32 focus:outline-none focus:border-blue-500 placeholder-gray-300"
            />
            </div>
            ...
            <div className="relative">
                <select className="appearance-none border border-gray-300 rounded px-3 py-1.5 w-32 bg-white focus:outline-none focus:border-blue-500 text-gray-400 pr-8">
        ...
        <div className="flex flex-wrap items-center gap-4">
            ...
            <button className="bg-blue-500 hover:bg-blue-600 text-white px-5 py-1.5 rounded text-sm transition-colors">
                搜索
            </button>
            <button className="bg-white border border-gray-300 hover:bg-gray-50 text-gray-600 px-5 py-1.5 rounded text-sm transition-colors">
                重置
            </button>
            </div>
        </div>
